async page => {
  ...
  await page.screenshot({ path: 'qa/l6r-play-08.png' })
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(4000)
  await page.screenshot({ path: 'qa/l6r-play-09.png' })
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(3500)
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(5000)
  await page.screenshot({ path: 'qa/l6r-play-10.png' })
  await dump('l6r-play-s05.json')
}
