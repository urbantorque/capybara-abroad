async page => {
  ...
  await walk('iceland', [0,1.4,99], [-40,0.4,-10], 45, 'town-to-spring')
  await walk('iceland', [-16,2,-80], [34,2,-88], 35, 'snout-to-cat')
  await page.evaluate(async (o) => { await fetch('/shot?name=y67walk2.json', { method:'POST', body: btoa(unescape(encodeURIComponent(JSON.stringify(o, null, 1)))) }) }, out)
}
