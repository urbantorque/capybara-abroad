async page => {
  ...
  await page.screenshot({ path: 'qa/l6r-play-11.png' })
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(1500)
  await page.screenshot({ path: 'qa/l6r-play-12.png' })
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(1500)
  await page.screenshot({ path: 'qa/l6r-play-13.png' })
  await page.waitForTimeout(6000)
  await page.screenshot({ path: 'qa/l6r-play-14.png' })
  await dump('l6r-play-s06.json')
}
