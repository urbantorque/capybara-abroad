async page => {
  ...
  await page.screenshot({ path: 'qa/l7r-play-07.png' })
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(3000)
  await page.screenshot({ path: 'qa/l7r-play-08.png' })
  await dump('l7r-play-s04a.json')
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(3500)
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(4500)
  await page.screenshot({ path: 'qa/l7r-play-09.png' })
  await dump('l7r-play-s04.json')
}
