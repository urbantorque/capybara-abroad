...
// Reads qa/l6-e6-wear2.json.png (from qa/l6-e6-wear.js): for every sample
...
const J = JSON.parse(readFileSync('qa/l6-e6-wear2.json.png', 'utf8'));
function inHud(x, y, w, h) { return (x < w * 0.24 && y < h * 0.47) || (x > w * 0.84 && y > h * 0.73); }
for (const r of J.rows) {
  const f = 'qa/l6-e6-wear2-' + r.biome + '.png';
