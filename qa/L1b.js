async page => {
  ...
  await page.evaluate(async (o) => { await fetch('/shot?name=L1b.json', { method:'POST', body: btoa(unescape(encodeURIComponent(JSON.stringify(o)))) }) }, out)
}
