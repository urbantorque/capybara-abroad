async page => {
  ...
  await page.screenshot({ path: 'qa/l7r-play-53.png' })
  await page.waitForTimeout(6000)
  await page.screenshot({ path: 'qa/l7r-play-54.png' })
  await dump('l7r-play-s27a.json')
  ...
  await page.screenshot({ path: 'qa/l7r-play-55.png' })
  await page.waitForTimeout(1500)
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(2500)
  await page.screenshot({ path: 'qa/l7r-play-56.png' })
  await dump('l7r-play-s27.json')
}
