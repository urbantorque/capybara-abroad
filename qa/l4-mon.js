async page => {
  ...
  // later; eveAudit before and after. qa/l4m-<biome>-{day,eve}.png, read by
  // qa/l4r-art-value.mjs and qa/l4-bands.mjs. qa/l4-mon.json
  ...
  for (const [name, key] of CH) {
    ...
    await page.screenshot({ path: 'qa/l4m-' + name + '-day.png', timeout: 90000 })
    ...
    await page.screenshot({ path: 'qa/l4m-' + name + '-eve.png', timeout: 90000 })
  ...
  await page.evaluate((o) => fetch('/shot?name=l4-mon.json', { method: 'POST', body: btoa(unescape(encodeURIComponent(JSON.stringify(o, null, 1)))) }), out)
}
