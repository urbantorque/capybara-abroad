async page => {
  ...
  const out = await page.evaluate(async (SPOTS) => {
    ...
    return res
  }, [{n:"Z-figs",b:"sydney",x:-19,y:1.0,z:9,yaw:0.4,hold:200},{n:"Z-van",b:"sydney",x:-46,y:1.0,z:6,yaw:-1.4,hold:900},{n:"Z-gardens",b:"sydney",x:26,y:1.0,z:22,yaw:1.2,hold:200}])
