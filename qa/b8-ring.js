    ...
    for (const R of [20, 45, 70, 95]) {
      ...
      for (let a = 0; a < 6.283; a += 20 / R) {
        ...
        for (let i = 0; i < pts.length; i += 3) {
          ...
          // JUDGE BY THE RADIUS, NOT BY THE ORIGIN HEIGHT. A y0 + 0.30 floor
          // here dropped every field wall, shrub and coffee bush in Pasto,
          // because they are all PLACED at ground level and grow upward from
          // it - the origin is at y0 - 0.06. That read a dressed hillside as
          // 0 per cent. The 0.40 m radius test above is what excludes crumbs.
