async page => {
  ...
  await page.screenshot({ path: 'qa/l6r-play-78.png' })
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(700)
  await page.screenshot({ path: 'qa/l6r-play-79.png' })
  await page.waitForTimeout(2500)
  await page.screenshot({ path: 'qa/l6r-play-80.png' })
  await dump('l6r-play-s36a.json')
  await page.keyboard.down('KeyW')
  await page.waitForTimeout(4000)
  await page.keyboard.up('KeyW')
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(1500)
  await page.screenshot({ path: 'qa/l6r-play-81.png' })
  await dump('l6r-play-s36.json')
}
