async page => {
  ...
  const names = ['sydney', 'venice', 'goreme', 'sahara', 'hanoi', 'kowloon', 'rio', 'cali',

                 'quay', 'kyoto', 'iceland', 'drift', 'palawan', 'manly', 'pantanal', 'cave', 'antarctic', 'monaco', 'pasto'];
  const res = {};
  ...
  await page.evaluate(async (o) => {
    await fetch('/shot?name=l7-e6-fuzz.json', { method: 'POST',
