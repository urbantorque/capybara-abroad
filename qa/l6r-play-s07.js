async page => {
  ...
  await page.screenshot({ path: 'qa/l6r-play-15.png' })
  await page.waitForTimeout(2500)
  await page.screenshot({ path: 'qa/l6r-play-16.png' })
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(2500)
  await page.keyboard.press('KeyQ')
  await page.waitForTimeout(2500)
  await page.screenshot({ path: 'qa/l6r-play-17.png' })
  await dump('l6r-play-s07.json')
}
