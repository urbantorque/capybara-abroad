async page => {
  ...
  const follow = async (id, secs, tag, reach) => {
    const held = new Set()
  ...
  await follow('steal-hat', 40, 'l4r-player-sydney-hat', 1.6)
  await page.waitForTimeout(1500)
  await snap('l4r-player-sydney-hat-end')
  out.lines = await drain()
  await post('l4r-player-06.json', out)
}
