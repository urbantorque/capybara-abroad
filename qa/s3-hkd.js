async page => {
  ...
  await cam({ biome:'kowloon', warm:200, px:20, py:1.4, pz:18, cx:14, cy:4.2, cz:18, tx:40, ty:1.6, tz:18, name:'HD-market.png' })
  await cam({ biome:'kowloon', px:29, py:1.4, pz:14, cx:22, cy:3.4, cz:26, tx:34, ty:1.4, tz:14, name:'HD-market2.png' })
  ...
  await page.evaluate(async (o) => { await fetch('/shot?name=hkd.json', { method:'POST', body: btoa(JSON.stringify(o)) }) }, err)
}
