async page => {
  ...
  await page.screenshot({ path: 'qa/l6r-play-22.png' })
  await page.keyboard.press('KeyE')
  await page.waitForTimeout(1500)
  await page.screenshot({ path: 'qa/l6r-play-23.png' })
  await page.keyboard.down('KeyD')
  await page.waitForTimeout(1000)
  await page.keyboard.up('KeyD')
  await page.keyboard.press('KeyE')
  await page.waitForTimeout(1500)
  await page.screenshot({ path: 'qa/l6r-play-24.png' })
  await dump('l6r-play-s10.json')
}
