async page => {
  ...
  await page.screenshot({ path: 'qa/l6r-play-25.png' })
  await page.keyboard.down('KeyS')
  await page.waitForTimeout(4000)
  await page.keyboard.up('KeyS')
  await page.waitForTimeout(500)
  await page.screenshot({ path: 'qa/l6r-play-26.png' })
  await dump('l6r-play-s11a.json')
  await page.keyboard.down('KeyS')
  await page.waitForTimeout(4000)
  await page.keyboard.up('KeyS')
  await page.waitForTimeout(500)
  await page.screenshot({ path: 'qa/l6r-play-27.png' })
  await dump('l6r-play-s11.json')
}
