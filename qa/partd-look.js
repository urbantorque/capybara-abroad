async page => {
  ...
  const KEY = 'BracketLeft'
  const LOOKS = [{ n: 'goreme-westridge', p: [4, 14, 32], t: [-98, 22, 20] },
                 { n: 'goreme-apron', p: [14, 12, 30], t: [-6, 4, 6] }]
  ...
  for (const L of LOOKS) {
    ...
    await page.evaluate(async (o) => { await fetch('/shot?name=' + o.n, { method: 'POST', body: o.u }) }, { n: 'WOW-D-' + L.n, u: png })
  }
}
