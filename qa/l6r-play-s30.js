async page => {
  ...
  await page.screenshot({ path: 'qa/l6r-play-67.png' })
  await dump('l6r-play-s30a.json')
  await page.keyboard.down('KeyW')
  await page.waitForTimeout(3000)
  await page.keyboard.up('KeyW')
  await page.screenshot({ path: 'qa/l6r-play-68.png' })
  await dump('l6r-play-s30b.json')
  await page.keyboard.down('KeyR')
  await page.waitForTimeout(2500)
  await page.keyboard.up('KeyR')
  await page.waitForTimeout(2500)
  await page.screenshot({ path: 'qa/l6r-play-69.png' })
  await dump('l6r-play-s30.json')
}
