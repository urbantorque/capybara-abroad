async page => {
  ...
  await cam({ biome:'kowloon', warm:400, px:0, py:1.4, pz:6, cx:0, cy:6, cz:26, tx:0, ty:6, tz:-16, name:'HA-street.png' })
  await cam({ biome:'kowloon', warm:120, px:7.4, py:1.4, pz:10, cx:2, cy:3.4, cz:20, tx:9, ty:1.6, tz:2, name:'HA-crowd.png' })
  await cam({ biome:'kowloon', warm:120, px:0, py:1.4, pz:34, cx:0, cy:6, cz:48, tx:0, ty:5, tz:14, name:'HA-arrival.png' })
  ...
  await page.evaluate(async (o) => { await fetch('/shot?name=hka.json', { method:'POST', body: btoa(JSON.stringify(o)) }) }, err)
}
