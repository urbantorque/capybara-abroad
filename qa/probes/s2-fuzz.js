async page => {
  await page.reload(); await page.waitForTimeout(5000); await page.mouse.click(400,400); await page.waitForTimeout(1500);
  ...
  await page.evaluate(async (o) => {
    await fetch('/shot?name=s2fuzz.json', { method: 'POST',
