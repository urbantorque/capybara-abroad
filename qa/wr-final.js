async page => {
  ...
  await cam({ biome:K, warm:150, px:0,py:1.4,pz:34, cx:0,cy:3.4,cz:46, tx:0,ty:8,tz:6, name:'Z1-hk-arrival.png' })
  await cam({ biome:K, warm:60, px:0,py:1.4,pz:0, cx:0,cy:3.2,cz:16, tx:0,ty:7,tz:-24, name:'Z1-hk-street.png' })
  await cam({ biome:K, warm:60, px:-8,py:1.4,pz:0, cx:3,cy:5,cz:14, tx:-11,ty:24,tz:-2, name:'Z1-hk-scaffold.png' })
  await cam({ biome:K, warm:60, px:29,py:1.4,pz:18, cx:16,cy:3,cz:18, tx:40,ty:2.5,tz:18, name:'Z1-hk-market.png' })
  await cam({ biome:K, warm:60, px:0,py:1.4,pz:-52, cx:-16,cy:8,cz:-40, tx:10,ty:12,tz:-70, name:'Z1-hk-pier.png' })
