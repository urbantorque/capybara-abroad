async page => {
  ...
  const shots = [
    ['F6-pan-faz', 'pantanal', 36, 86, 3.14],
    ['F6-pan-capao', 'pantanal', 48, -2, 3.14],
    ['F6-pan-campo', 'pantanal', 50, 34, 3.14],
    ['F6-pan-cross', 'pantanal', -34, -62, 3.14],
    ['F6-pan-bar', 'pantanal', 34, -60, 3.14],
    ['F6-pan-arrive', 'pantanal', 0, 62, 3.14],
  ]
