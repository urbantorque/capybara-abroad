async page => {
  ...
  await cam({ biome:'antarctic', px:108, pz:36, warm:180, cx:130, cy:14, cz:52, tx:105, ty:2, tz:20, name:'H-ant-whal.png' })
  await cam({ biome:'antarctic', px:114, pz:20, warm:150, name:'H-ant-bones.png' })
  await cam({ biome:'antarctic', px:24, pz:96, warm:150, cx:44, cy:14, cz:110, tx:18, ty:0, tz:86, name:'H-ant-colony.png' })
  ...
  await page.evaluate(async (o) => { await fetch('/shot?name=h-ant.json', { method:'POST', body: btoa(unescape(encodeURIComponent(JSON.stringify(o)))) }) }, out)
}
