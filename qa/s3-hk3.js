async page => {
  ...
  await cam({ biome:'kowloon', warm:200, px:0, py:1.4, pz:-56, cx:0, cy:7, cz:-40, tx:0, ty:16, tz:-140, name:'H3-harbour.png' })
  await cam({ biome:'kowloon', warm:60*80, px:-10.5, py:35.4, pz:0, cx:-4, cy:44, cz:16, tx:-12, ty:34, tz:-60, name:'H3-showroof.png' })
  await cam({ biome:'kowloon', warm:60*6, px:0, py:1.4, pz:-56, cx:0, cy:7, cz:-40, tx:0, ty:16, tz:-140, name:'H3-show.png' })
  ...
  await page.evaluate(async (o) => { await fetch('/shot?name=hk3.json', { method:'POST', body: btoa(JSON.stringify(o)) }) }, err)
}
