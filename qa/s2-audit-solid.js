async page => {
  await page.reload(); await page.waitForTimeout(5000); await page.mouse.click(400, 400)
  ...
  await page.evaluate(async (o) => {
    await fetch('/shot?name=s2auditsolid.json', { method: 'POST', body: btoa(unescape(encodeURIComponent(JSON.stringify(o, null, 1)))) })
  }, out)
}
