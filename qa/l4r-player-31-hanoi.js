async page => {
  ...
  await follow('pho-raid', 40, 'l4r-player-hanoi-pho', 1.4, false)
  await page.waitForTimeout(1500); await snap('l4r-player-hanoi-pho-end')
  await follow('pho-run', 70, 'l4r-player-hanoi-sc', 1.6, false)
  await page.waitForTimeout(800); await page.keyboard.press('KeyE'); await page.waitForTimeout(1500); await snap('l4r-player-hanoi-sc-on')
  await page.keyboard.down('KeyW')
  for (let i = 0; i < 5; i++) { await page.waitForTimeout(3000); await snap('l4r-player-hanoi-ride-' + i) }
  await page.keyboard.up('KeyW')
  await page.waitForTimeout(1500); await snap('l4r-player-hanoi-ride-end')
  out.lines = await drain()
  await post('l4r-player-31.json', out)
}
