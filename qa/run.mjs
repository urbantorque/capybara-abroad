...
const ASSERTS = [
  ...
  ['qa/homecoming-audition-contract.mjs', 'soundtrack capture destination topology and ownership'],
  ['qa/homecoming-resolution.mjs', 'stable canvas, offscreen resolution and frame-tail governor'],
  ...
  ['qa/homecoming-loose-ownership.mjs', 'dropped travelling props retain global scene ownership'],
  ...
  ['qa/ten-t2a-static.mjs', 'the story beats: card ranks, the memory, the act turn, the grace and the held guard'],
  ['qa/ten-t3a-static.mjs', 'the sketchbook: the free page, the stamp, the milestones, the wall and the door guard'],
  ['qa/ten-t4a-static.mjs', 'the ending: the caption, the bag, the last frame, the epilogue and the carry-ins'],
