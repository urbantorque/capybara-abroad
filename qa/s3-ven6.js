async page => {
  ...
  await cam({ biome:'venice', warm:200, px:-4, py:1.6, pz:-40, cx:-4, cy:7, cz:-30, tx:-4, ty:8, tz:-62, name:'V6-basilica.png' })
  await cam({ biome:'venice', px:-4, py:1.6, pz:-30, cx:-4, cy:2.2, cz:-25, tx:-4, ty:1.1, tz:-34, name:'V6-pigeon.png', fov:38 })
  await cam({ biome:'venice', px:-17.8, py:1.0, pz:-14, cx:-12, cy:3.6, cz:-7, tx:-19, ty:1.6, tz:-20, name:'V6-cafe.png' })
  await cam({ biome:'venice', warm:150, px:-4, py:1.6, pz:13, cx:-4, cy:7, cz:24, tx:-4, ty:3, tz:-6, name:'V6-arrival.png' })
  ...
  await page.evaluate(async (o) => { await fetch('/shot?name=v6info.json', { method:'POST', body: btoa(unescape(encodeURIComponent(JSON.stringify(o)))) }) }, st)
}
