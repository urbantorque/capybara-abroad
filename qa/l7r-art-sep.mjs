// qa/l7r-art-sep.mjs — the animal's value separation from its surround, per
// settled frame. Reads the animal's projected box from qa/l7r-art-shots.json.png
...
//   node qa/l7r-art-sep.mjs
import { readFileSync } from 'node:fs';
import { pngRead } from './pnghist.mjs';
const rows = JSON.parse(readFileSync('qa/l7r-art-shots.json.png', 'utf8')).rows;
...
for (const r of rows) {
  const path = 'qa/l7r-art-' + r.biome + '-' + r.tag + '.png';
