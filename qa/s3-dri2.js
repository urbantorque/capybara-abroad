async page => {
  ...
  await cam({ biome:'drift', warm:200, px:2, py:31.6, pz:42, cx:2, cy:37, cz:56, tx:0, ty:31, tz:20, name:'D2-arrival.png' })
  await cam({ biome:'drift', px:-38, py:81, pz:-114, cx:-18, cy:90, cz:-96, tx:-46, ty:80, tz:-124, name:'D2-orchard.png' })
  await cam({ biome:'drift', px:0, py:85, pz:-98, cx:-2, cy:89, cz:-92, tx:14, ty:82, tz:-118, name:'D2-arch.png' })
  await cam({ biome:'drift', px:5, py:85, pz:-108, cx:1, cy:88, cz:-100, tx:34, ty:76, tz:-134, name:'D2-gap.png' })
  ...
  await page.evaluate(async (o) => { await fetch('/shot?name=dri2.json', { method:'POST', body: btoa(JSON.stringify(o)) }) }, err)
}
